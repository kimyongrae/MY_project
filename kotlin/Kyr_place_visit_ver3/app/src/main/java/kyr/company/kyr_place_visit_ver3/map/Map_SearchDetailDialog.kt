...
import kyr.company.kyr_place_visit_ver3.databinding.MapSearchDetailBinding
import java.util.*

class Map_SearchDetailDialog() : DialogFragment(),
    DatePickerFragment.OnInputDateSelected {

    private lateinit var binding: MapSearchDetailBinding
    ...
    companion object {
        fun newInstance(): Map_SearchDetailDialog? {
            return Map_SearchDetailDialog()
        }
    }
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater,
                R.layout.map_search_detail, container, false)
        return binding.root
    }
...
/*        if(context is OnSearchDateSendListner){
    ...
    private fun init(): Unit {
        ...
        binding.timeButton.setOnClickListener {
            val dialog: TimeCustomDialog =
                TimeCustomDialog(context!!)
            dialog.startDialog()
