...
import kyr.company.kyr_place_visit_ver3.databinding.WriteMapDialogBinding
...
class Write_MapDialog: DialogFragment(), OnMapReadyCallback {
    ...
    companion object{
        ...
        fun newInstance(): Write_MapDialog? {
            return Write_MapDialog()
        }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = DataBindingUtil.inflate(inflater,
            R.layout.write_map_dialog, container, false)
        return binding.root
    }
